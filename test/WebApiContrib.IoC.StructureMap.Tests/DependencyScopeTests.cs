...
namespace WebApiContrib.IoC.StructureMap.Tests
{
    ...
    {     
        ...
        private static HttpRequestMessage CreateRequestWithConfiguration()
        {
            ...
            {
                DependencyResolver = new StructureMapResolver(ParentContainer)
            };
        ...
        private static readonly Lazy<IContainer> _lazyContainer = new Lazy<IContainer>(() =>
        {
        ...
        private static IContainer ParentContainer { get { return _lazyContainer.Value; } } 
